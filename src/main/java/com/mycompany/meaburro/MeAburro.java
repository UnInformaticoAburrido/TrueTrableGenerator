...
public class MeAburro {
    ...
    public static void main(String[] args) {
        ...
        while (queap) {
                ...
                System.out.println("1 = Exe las salidas estaran formatadas para poderse mover a una hoja de calculos");
                System.out.println("2 = Estandar las salidas no tendran formato");
